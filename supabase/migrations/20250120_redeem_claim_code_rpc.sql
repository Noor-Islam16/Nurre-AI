-- Migration: 20250120_redeem_claim_code_rpc.sql
-- Purpose: Add SECURITY DEFINER RPC to redeem claim codes with multi-use support and 3-coach cap.
-- Status: COMPLETED
-- Executed: 2025-01-20
-- Author: AI Assistant
-- Date: 2025-01-20
...
BEGIN
  ...
  END IF;
  RAISE NOTICE 'Migration ok: redeem_claim_code created.';
END $$;
